 # -*- coding: utf-8 -*-
"""
Created on Fri Jul 30 17:04:34 2021
...
def save_imgs(epoch):
    ...
    for i in range(r):
        for j in range(c):
            ...
            axs[i,j].axis('off')
            cnt += 1
    fig.savefig("images10000/mnist_%d.png" % epoch)
    plt.close()
...
train(epochs=10000, batch_size=32, save_interval=60)

#Save model for future use to generate fake images
#Not tested yet... make sure right model is being saved..
#Compare with GAN4

generator.save('generator_model10000.h5')  #Test the model on GAN4_predict...
